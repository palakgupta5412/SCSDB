  ...
  return (
    data &&
        <div className='w-full flex overflow-x-auto'>
            {data.map((d,i)=>{
                return(
                    <Link to={ `/${d.media_type}/details/:${d.id}`} key={i} className='ml-4 p-2 h-[50vh] min-w-[20%] mr-1 flex flex-col bg-zinc-700 mb-4 rounded-md text-zinc-300 overflow-hidden'>
