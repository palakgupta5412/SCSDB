  ...
  return (
    <div className='p-2 w-[20%] border-r-2 border-zinc-500'>
        ...
        <nav className='flex flex-col gap-3 my-10 ml-5'>
            ...
            <Link to={'/about'} className='p-2 text-zinc-400 pl-5 hover:text-white hover:bg-[#6556CD] rounded-lg mr-5'><i className="ri-information-fill mr-2"></i>About SCSDB</Link>
            <Link to={'/contact'} className='p-2 text-zinc-400 pl-5 hover:text-white hover:bg-[#6556CD] rounded-lg mr-5'><i className="ri-phone-fill mr-2 "></i>Contact Us</Link>
        </nav>
