    ...
    <div 
        ...
        className=' realative w-[99%]  h-[60%] mx-auto flex flex-col justify-end items-start p-[5%] '>
            ...
            <p className='w-[60%] mt-4 flex justify-between pr-16 font-bold text-sm'>
                <span className='text-white text-md'><i className="text-yellow-500 text-lg ri-broadcast-fill"></i> {data.release_date ? data.release_date : data.first_air_date}</span>
